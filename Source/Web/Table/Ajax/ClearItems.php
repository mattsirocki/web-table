 ...
 * @version    SVN: $Id: ClearItems.php 112 2013-03-10 21:06:02Z ll77ll $
...
/**
 * Web Table Operation: ClearItems
 *
 * @category   Web
 * @package    Web_Table
 * @author     Matt Sirocki <mattsirocki@gmail.com>
 ...
 */
class ClearItems extends \Web\Table\Ajax
{
    /**
     * Handle ClearItems (Data)
     *
     * @return void
     */
    public function processData()
    {
        // Error Checking
        if ($this->table === null)
            $this->sendFail('Clear Items', 'You must specify a Table in the request.');
        if (count($this->arguments) != 0)
            $this->sendFail('Clear Items', 'You must specify exactly zero arguments in the request.');
    ...
    public function processForm()
    {
        ...
        // Construct Message
        $message  =  <<<HTML
            Please confirm that you wish to remove all Items from the Group
...
HTML;
        ...
        $note = <<<HTML
            <p>
                Click <b>Confirm</b> to <b>Remove</b> all Items from the
