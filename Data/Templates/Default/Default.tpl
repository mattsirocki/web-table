...
-->
{% form %}
<div class="web-table-default-form" id="{table-id}-form">
  <form action="#">
...
<div class="web-table-default-form-background" id="{table-id}-form-background"></div>
{% end %}
...
{% table-header %}
<div class="web-table-default" id="{table-id}">
...
{% row-header %}
<div class="web-table-default-row" id={row-id}>
...
{% cell-header %}
<div class="web-table-default-cell" id="{cell-id}">
...
{% group-header %}
<div class="web-table-default-group" id="{group-id}">
...
{% item-header %}
<div class="web-table-default-item" id="{item-id}">
